...
Cables carry energy between components. Each cable type has a hard transfer cap — send more E/t than its rated limit and the cable vaporizes. Tin Cable handles up to 32 E/t; Copper up to 128 E/t; Gold up to 512 E/t. See [Cables & Transformers](./cables-and-transformers) for the full list.
...
Quick reference — see [Power Tiers](./power-tiers) for the authoritative table.
...
See [Cables](../power/cables) for per-type stats.
...
- [Power Tiers](./power-tiers) — full tier table and explosion behavior
- [Cables & Transformers](./cables-and-transformers) — per-cable stats and Transformer usage
- [Generators](../power/generators) — all generator reference pages
- [Energy Storage](../power/storage) — all storage unit reference pages
- [Cables](../power/cables) — all cable reference pages
